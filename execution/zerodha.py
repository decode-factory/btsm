# zerodha.py
# Implementation of Zerodha (Kite) trading interface
...
# Define both class names for backward compatibility
# Main class is ZerodhaBroker, but ZerodhaInterface is also exposed for imports
# Will be assigned after class definition
ZerodhaInterface = None
...
# Assign ZerodhaInterface to ZerodhaBroker for backward compatibility
ZerodhaInterface = ZerodhaBroker